...
export default function InscriptionsNonMembresAgencePage() {
  return (
    <div className="space-y-6 px-6 mt-6">
      ...
      <WidgetNonMembres />
      <ListeInscriptions userProfile="agence" defaultStatuts={['non-membre']} restrictStatutOptions={['non-membre']} />
    </div>
  );
}
