            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">{inscriptionsCounts.membres + inscriptionsCounts.nonMembres + inscriptionsCounts.vip + inscriptionsCounts.speakers} / {totals.participants}</div>
                    <p className="text-xs text-muted-foreground mt-1">Finalisées (incl. exonérés VIP/Speakers) / Total inscrits</p>
                  </CardContent>
                </Card>
