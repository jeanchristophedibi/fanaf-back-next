...
export const FooterNav: React.FC<FooterNavProps> = ({ etapeActuelle, loading, onPrev, onNext, disabled, disabledReason }) => {
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between relative z-[10000]">
        ...
        <div className="flex flex-col items-end gap-1">
          {disabledReason && !loading && (
            <span className="text-sm text-amber-600">{disabledReason}</span>
          )}
          <Button
            type="button"
            onClick={onNext}
